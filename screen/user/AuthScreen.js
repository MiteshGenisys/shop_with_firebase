...
import {View, KeyboardAvoidingView, ScrollView, StyleSheet, Button, ActivityIndicator, Alert} from 'react-native';
            ...
            <Cart style={styles.authContainer}>
                ...
                <View style={styles.buttonContainer}>
                    <Button title={`Switch to ${isSignup ? 'Login' : 'Sign Up'}`} 
                            color={Colors.accent} 
                            onPress={() => {
                                setIsSighnup(prevState => !prevState);
                            }} 
                    />
                </View>
                </ScrollView>
